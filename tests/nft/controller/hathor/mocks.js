...
exports.loadNockMocks = (nock, wallets) => {
  nock(baseUrl)
    ...
    .persist()
  nock(baseUrl)
    .get(`/nft/003b7e66586d774b35ac52cd161cad9c392fb468dfdfe3aade1a93d7fcdb2f03/balance/WbrQizEXgaXu9y6VCb5fpSzhyf28U4UZFK`)
    .query({
      protocol: Protocol.HATHOR,
    })
    .reply(200, {
    ...
    .persist()
  nock(baseUrl)
    .get(`/nft/003b7e66586d774b35ac52cd161cad9c392fb468dfdfe3aade1a93d7fcdb2f03/metadata`)
    .query({
      protocol: Protocol.HATHOR,
    })
    .reply(200, {
