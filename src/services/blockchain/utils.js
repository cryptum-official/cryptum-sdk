...
module.exports.toWei = (eth, decimals = 18) => new BigNumber(eth).times(`1e${decimals}`)
module.exports.fromWei = (wei, decimals = 18) => new BigNumber(new BigNumber(wei).div(`1e${decimals}`).toFixed(Number(decimals)))
...
module.exports.toLamports = (v, decimals = 9) => new BigNumber(new BigNumber(v).times(`1e${decimals}`).toFixed(Number(decimals)))
module.exports.fromLamports = (v, decimals = 9) => new BigNumber(new BigNumber(v).div(`1e${decimals}`).toFixed(Number(decimals)))
