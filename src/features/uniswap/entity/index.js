 ...
 * @property {string} price desired price of tokenA/tokenB for the pool to be intiated
 */
/**
 ...
 * @property {import('../../wallet/entity').Wallet} wallet
 * @property {import('../../../services/blockchain/constants').Protocol} protocol
 * @property {string} tokenIn address of the input token to be sent
 ...
 * @property {import('../../wallet/entity').Wallet} wallet
 * @property {Object} transaction swap transaction quotation object
 */
/**
 * @typedef {Object} IncreaseLiquidityInput
 * @property {import('../../wallet/entity').Wallet} wallet
 * @property {Object} transaction increase liqudity transaction quotation object
 */
